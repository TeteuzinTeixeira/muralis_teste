...
public class LancamentoResource {
    ...
    public ResponseEntity atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
        ...
        }).orElseGet( () -> new ResponseEntity("lancamento não encontrando da base de Dados.", HttpStatus.BAD_REQUEST));
    }
    ...
    public ResponseEntity buscar (
        ...
        if (!usuario.isPresent()) {
            return ResponseEntity.badRequest().body("Não foi possivel realizar a consulta. usuario nao encontrado");
        }else {
    ...
    @GetMapping("{id}")
    public ResponseEntity obterLancamento(@PathVariable("id") Long id) { return service.obterPorId(id)
